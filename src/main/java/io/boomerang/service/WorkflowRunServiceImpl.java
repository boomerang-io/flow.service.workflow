...
public class WorkflowRunServiceImpl implements WorkflowRunService {
  ...
  public ResponseEntity<WorkflowRun> get(String workflowRunId, boolean withTasks) {
    ...
    List<String> workflowRunRefs = relationshipService.getFilteredFromRefs(Optional.of(RelationshipNodeType.WORKFLOWRUN), Optional.of(List.of(workflowRunId)), Optional.of(RelationshipLabel.BELONGSTO), Optional.of(RelationshipNodeType.TEAM), Optional.empty());
  ...
  public WorkflowRunResponsePage query(
    ...
    List<String> workflowRunRefs = relationshipService.getFilteredFromRefs(
        Optional.of(RelationshipNodeType.WORKFLOWRUN), queryWorkflowRuns,
  ...
  public WorkflowRunInsight insight(Optional<Long> from, Optional<Long> to,  Optional<List<String>> queryLabels, Optional<List<String>> queryWorkflows, Optional<List<String>> queryTeams) {
    List<String> workflowRunRefs = relationshipService.getFilteredFromRefs(Optional.of(RelationshipNodeType.WORKFLOWRUN), Optional.empty(), Optional.of(RelationshipLabel.BELONGSTO), Optional.of(RelationshipNodeType.TEAM), queryTeams);
  ...
  public WorkflowRunCount count(Optional<Long> from, Optional<Long> to,  Optional<List<String>> queryLabels, Optional<List<String>> queryTeams, Optional<List<String>> queryWorkflows) {
    List<String> refs = relationshipService.getFilteredFromRefs(Optional.of(RelationshipNodeType.WORKFLOW), queryWorkflows, Optional.of(RelationshipLabel.BELONGSTO), Optional.of(RelationshipNodeType.TEAM), queryTeams);
  ...
  public ResponseEntity<WorkflowRun> start(String workflowRunId,
    ...
    List<String> workflowRunRefs = relationshipService.getFilteredFromRefs(Optional.of(RelationshipNodeType.WORKFLOWRUN), Optional.of(List.of(workflowRunId)), Optional.of(RelationshipLabel.BELONGSTO), Optional.empty(), Optional.empty());
    if (!workflowRunRefs.isEmpty()) {
