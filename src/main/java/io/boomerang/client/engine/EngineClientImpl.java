package io.boomerang.client.engine;
...
import io.boomerang.mongo.entity.WorkflowRunEntity;
import io.boomerang.mongo.entity.TaskRunEntity;
...
import io.boomerang.service.ControllerRequestProperties;
...
public class EngineClientImpl implements EngineClient {
  ...
  public boolean createFlow(String workflowId, String workflowName, String activityId,
    ...
    WorkflowRunEntity activity = this.activityService.findWorkflowActivity(activityId);
    try {
  ...
  public void terminateTask(Task task) {
    TaskRunEntity taskExecution = taskService.findById(task.getTaskActivityId());
    WorkflowRunEntity activity =
