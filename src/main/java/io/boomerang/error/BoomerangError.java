...
public enum BoomerangError {
  ...
  TASKTEMPLATE_INVALID_REF(1401, "TASKTEMPLATE_INVALID_REFERENCE", HttpStatus.BAD_REQUEST),
  TASKTEMPLATE_ALREADY_EXISTS(1402, "TASKTEMPLATE_ALREADY_EXISTS", HttpStatus.BAD_REQUEST),
  TASKTEMPLATE_INVALID_NAME(1403, "TASKTEMPLATE_INVALID_NAME", HttpStatus.BAD_REQUEST),
  TASKTEMPLATE_INACTIVE_STATUS(1404, "TASKTEMPLATE_INACTIVE_STATUS", HttpStatus.BAD_REQUEST),
