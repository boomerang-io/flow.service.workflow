...
public class SucessFlowExecutionTests extends FlowExecutionTest {
  ...
  public void testExecuteFlow() throws InterruptedException, ExecutionException {
    FlowWorkflowActivityEntity activity = this.testSuccessExecuteFlow("5d7177af2c57250007e3d7a1");
